    ...
    return (
        <div className="max-w-7xl mx-auto px-4 py-16 bg-secondary/30">
            <div className="text-center mb-12">
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border bg-red-
                                ...
                                <div className="space-y-4 py-4">
                                    ...
                                    >
                                        <div className="flex flex-col items-center gap-4">
                                            <div className="h-16 w-16 rounded-full bg-blue-100 dark:bg-blue-900/30
flex items-center justify-center">
                            ...
                            <>
                                ...
                                <div className="space-y-6 py-4">
                                    {/* Overall Score */}
                                    <div className={`p-6 rounded-lg ${getScoreBgColor(response.atsScore)}
                                                border-2`}>
